    ...
    return MaterialApp(
      ...
      home: MultiProvider(
        ...
        providers: [
          ...
          //ChangeNotifierProvider.value(value: CountProvider2()),
...
class MyCountPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    CountProvider _state = Provider.of(context); //!!! _state =
    return Scaffold(
      body: Center(
        child: Column(
            ...
            ButtonBar(
              ...
              children: <Widget>[
                IconButton(
                  ...
                  color: Colors.red,
                  onPressed: () => _state._decrementCount(), // !!! _state.
                ),
                Consumer<CountProvider>(
                  // !!! Consumer<> start ВАЖНО
...
class MyEventPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var _value = Provider.of<int>(context); //! <int>
